...
class CatatanPerjalananController extends Controller
{
    ...
    {
        $data = DetailCatatan::all();
        return view('isidata', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data['users_id'] = 1;
        // dd($data);
        $storeData = DetailCatatan::create($data);
    ...
    {
        $data = DetailCatatan::findOrFail($id);
    ...
    {
        $data = DetailCatatan::findOrFail($id);
        $storeData = $data->update($request->all());
